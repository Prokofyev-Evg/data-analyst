...
def create_model(input_shape):
    ...
    model.add(Conv2D(filters=6, kernel_size=(3, 3), padding='same', input_shape=(224, 224, 3), activation='relu'))
    model.add(AveragePooling2D(pool_size=(2, 2)))
    model.add(Conv2D(filters=4, kernel_size=(3, 3), padding='same', input_shape=(224, 224, 3), activation='relu'))
